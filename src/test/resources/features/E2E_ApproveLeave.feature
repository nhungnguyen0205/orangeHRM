Feature: End to end_ Approve Leave
  Scenario: ESS user request leave, Admin approve this request and ESS user check Leave status
    ...
    And I type "2020-07-15" in "From Date" field
    And I type "2020-07-15" in "To Date" field
    ...
    And I click on "LOGIN" button
    Then I wait some seconds
    When At Pending Leave Request, I click on name "Fiona" with date "2020-07-15"
    Then I wait some seconds
    When At column 7, I select "Approve"
    ...
    Then At column 6, status of row which contains "2020-07-15" is changed to "Scheduled"
